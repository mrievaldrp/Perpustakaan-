...
class Transaksi extends Migration
{
    public function up()
    {
        $this->forge->addField([
            ...
            'kembalipustakawan_id'        =>[ 'type' => 'int', 'constraint' => 10, 'null' => true, 'unsigned'=>true, ],
        ...
        $this->forge->addForeignKey('stokkoleksi_id', 'anggota', 'id', 'cascade');
        $this->forge->addForeignKey('pustakawan_id', 'pustakawan', 'id', 'cascade');
        $this->forge->addForeignKey('kembalipustakawan_id', 'pustakawan', 'id', 'cascade');
